...
export GLOG_vmodule=ap_generic_drr_pass=8
...
# export FLAGS_enable_ap=0 && export FLAGS_ap_performance=0 && ${nsys_args} timeout 20 \
...
# export FLAGS_enable_ap=0 && export FLAGS_ap_performance=1 && ${nsys_args} timeout 28 \
